...
describe('LoginComponent', () => {
  ...
  let fixture: ComponentFixture<LoginComponent>; // Utilisé pour accéder au composant et interagir avec lui dans le contexte des tests.
  ...
  beforeEach(async () => { // Configuration avant chaque test
    authServiceMock = {
      login: jest.fn(),
    } as unknown as jest.Mocked<AuthService>;

    sessionServiceMock = {
      logIn: jest.fn(), // Simule les méthodes
    ...
    await TestBed.configureTestingModule({ // Configure le module de test Angular
    ...
    fixture = TestBed.createComponent(LoginComponent); // initialisation du composant
  ...
  it('should set onError to true on login failure', () => {
    ...
    component.form.setValue({ email: 'a@a.fr', password: 'password' });
    component.submit();
