...
describe('RegisterComponent', () => {
  ...
  beforeEach(async () => {
    ...
    authServiceMock = {
      register: jest.fn().mockReturnValue(of({})), // return un observable par defaut
  ...
  it('should create an error if not all fields are filled', () => {
    ...
    const incompleteRegistration = { lastName: 'lastname', firstName: 'firstname', email: '', password: 'password' }; // Champ email manquant
